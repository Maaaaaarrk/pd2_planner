...
var lastSelected = "";
var settings = {coupling:1, autocast:1, parameters:0, skill_value_placeholder:"X"}
var monsterID = 2;
...
var socketed = {	// Gems/Runes/Jewels Socketed in Equipment
	belt:{sockets:0, socketsFilled:0, totals:{}, items:[{id:"",name:""}]},
	amulet:{sockets:0, socketsFilled:0, totals:{}, items:[{id:"",name:""}]},
...
var oskills_info = {
	...
	oskill_Raven:{name:"Raven",native_class:"druid",i:21},
	oskill_Skeleton_Mastery:{name:"Skeleton Mastery",native_class:"necromancer",i:0},
};
