...
{name:"Metalgrid", req_level:81, ar:450, defense:350, all_res:35, cskill:[[22,"Iron Golem",11],[12,"Iron Maiden",20]]},
    ...
    {name: "The Third Eye", req_level: 90, all_skills: 1, fcr: 20, cbf: 1, light: -4, cast_skill: 25, energy: 50, sockets: 1},
...
var corruptions = {	// pdr
	...
	weapon: [
		...
		{name:"+ Fire Pierce", base:"quiver", enemy_fRes:10, sockets:4},
		{name:"+ Cold Pierce", base:"quiver", enemy_cRes:10, sockets:4},
		{name:"+ Light Pierce", base:"quiver", enemy_lRes:10, sockets:4},
		{name:"+ Psn Pierce", base:"quiver", enemy_pRes:10, sockets:4},
	],
	offhand: [
		{name:"Offhand"},
		// weapon
		...
		{name:"+ Fire Pierce", base:"weapon", base:"quiver", enemy_fRes:10, sockets:4},
		{name:"+ Cold Pierce", base:"weapon", base:"quiver", enemy_cRes:10, sockets:4},
		...
		{name:"+ Faster Run/Walk", base:"quiver", frw:10},
		{name:"+ Enhanced Damage", base:"quiver", e_damage:40},
		{name:"+ Pierce", base:"quiver", pierce:15},
		{name:"+ Fire Pierce", base:"quiver", enemy_fRes:10},
		{name:"+ Cold Pierce", base:"quiver", enemy_cRes:10},
	],
}
